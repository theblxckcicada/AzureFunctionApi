...
internal static class IServiceStorageEntityHandlerExtensions
{
    public static IServiceCollection AddStorageEntityHandlers(
    ...
    public static IServiceCollection AddStorageEntityHandlers<TModel, TKey>(
        this IServiceCollection services,
        bool replaceExistingImplementations = false
    )
